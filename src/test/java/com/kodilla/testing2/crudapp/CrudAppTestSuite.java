...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://janhulanicki.github.io/";
    ...
    private boolean checkTaskexistsInTrello(String taskName) throws InterruptedException {
        ...
        //driverTrello.findElement(By.id("user")).sendKeys("jan_hulanicki@poczta.onet.pl");
        //driverTrello.findElement(By.id("password")).sendKeys("password1234");
    ...
    private void cleanCrudTask(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                ...
                .forEach(aHref1 -> {
                    WebElement deleteButton = aHref1.findElement(By.xpath(".//fieldset[contains(@class, \"row-section--button-section\")]/button[4]"));
                    deleteButton.click();
                });
